...
public class Search1 {
	...
	public static void main(String[] args) {
		...
		(new Search1(hrand)).breadthFirst();
		// 深さ優先探索
		System.out.print("\nDepth First Search1,");
		(new Search1(hrand)).depthFirst();
		// 分岐限定法
		System.out.print("\nBranch and Bound Search1,");
		(new Search1(hrand)).branchAndBound();
		// 山登り法
		System.out.print("\nHill Climbing Search1,");
		(new Search1(hrand)).hillClimbing();
		// 最良優先探索
		System.out.print("\nBest First Search1,");
		(new Search1(hrand)).bestFirst();
		// A*アルゴリズム
		System.out.print("\nA star Algorithm,");
		(new Search1(hrand)).aStar();
		//hrandの表示
		System.out.print("\n[");
